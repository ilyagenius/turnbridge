...
* **Fast-Connect:** Автоматическое кеширование ссылок — повторные подключения за ~5-8 сек вместо ~10 сек. Ссылки ротируются и обновляются автоматически через VK bootstrap тоннель.
